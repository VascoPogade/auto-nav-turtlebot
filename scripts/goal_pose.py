...
if __name__ == "__main__":
    ...
    if status in [2, 3, 4, 5, 8, 41]:
        if pickup_point == "pickup_point1":
            move_to_goal(11.612991333007812,1.8986226320266724 , -0.6767184325390025, 0.7362419188432261)
            ...
            move_to_goal(14.80724048614502,0.6164495944976807 ,0.026950692485214478, 0.9996367641171304)
